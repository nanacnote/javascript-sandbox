...
export class Payment extends Manage {
  private driverUID: IPaymentProps["driverUID"];
  private name: IPaymentProps["name"];
  private ccn: IPaymentProps["ccn"];
  private ccv: IPaymentProps["ccv"];
  private exp: IPaymentProps["exp"];
  private state: IPaymentProps["state"];
  private annotation: IPaymentProps["annotation"];
