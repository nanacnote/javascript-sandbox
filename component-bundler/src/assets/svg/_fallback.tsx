...
function Fallback(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      <defs>
        <linearGradient
          ...
          y2="83.3183851%"
        >
          <stop stopColor="#F54747" offset="0%"></stop>
          <stop stopColor="#FAA768" offset="23.7588949%"></stop>
          <stop stopColor="#EC86D7" offset="50.0555612%"></stop>
          <stop stopColor="#7EC3F5" offset="100%"></stop>
        </linearGradient>
        s
      </defs>
