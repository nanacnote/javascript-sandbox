...
var main = function main(ROOT_URL) {
  ...
  $("#stage-content").load("content/siderContents/customGettingStartedContent.html", function () {
    $("#stage-edit-link>a").attr("href", "".concat(ROOT_URL, "/").concat(pkg.name, "/tree/master/docs/content/siderLinks/customGettingStartedContent.html"));
    $('button[data-content-ref="customGettingStartedContent"]').addClass("selected-left");
  ...
  $("#sider-content").delegate(".btn-no-decoration", "click", function () {
    ...
    var sectionID = _.kebabCase(btnCurrentRef);
    ...
    if (btnCurrentRef.split("-").length > 1) {
      ...
      $("#stage-content").load("content/siderContents/documentationContent.html", function () {
        $("#stage-edit-link>a").attr("href", "".concat(ROOT_URL, "/").concat(pkg.name, "/tree/master/docs/content/siderContents/documentationContent.html")); // adds selected left border styling
      ...
      $("#stage-content").load("content/siderContents/".concat(btnCurrentRef, ".html"), function () {
        $("#stage-edit-link>a").attr("href", "".concat(ROOT_URL, "/").concat(pkg.name, "/tree/master/docs/content/siderContents/").concat(btnCurrentRef, ".html")); // adds selected left border styling
...
},{"../../package.json":5,"./utils.lock":3,"lodash":4}],3:[function(require,module,exports){
"use strict";
...
module.exports = {
   ...
   * @param {string} htmlID
   */
  handleSectionHashTracking: function handleSectionHashTracking(htmlID) {
    window.history.pushState({}, "", "#".concat(htmlID));
